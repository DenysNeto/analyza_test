    ...
    if (l.length) {
      ...
      for (var w, x = !1, k = e.ractive.warnAboutAmbiguity, _ = 0; e; ) {
        if (
          ...
          return (
            x &&
              (w = i.ractive.viewmodel.createLink(c, w, c, {
                implicit: !0,
              })),
    ...
    tp = $o.extend({
      ...
      converters: [
        ...
        function (t) {
          ...
          for (var n; (n = t.read()); ) {
            if ((e.push(n.v), t.sp(), t.matchString("]")))
              return {
                v: e,
              };
            if (!t.matchString(",")) return null;
